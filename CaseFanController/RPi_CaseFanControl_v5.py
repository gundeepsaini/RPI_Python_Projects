...
# Auto start script: https://learn.sparkfun.com/tutorials/how-to-run-a-raspberry-pi-program-on-startup/all
# sudo nano /etc/rc.local
# python3 /home/pi/Desktop/Auto_start_script/RPi_CaseFanControl_v5.py &
